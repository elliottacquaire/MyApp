package com.exple.ex_elli.myapp.zxingcode.zxing.activity;
...
import com.exple.ex_elli.myapp.zxingcode.zxing.camera.CameraManager;
import com.exple.ex_elli.myapp.zxingcode.zxing.decoding.CaptureActivityHandler;
import com.exple.ex_elli.myapp.zxingcode.zxing.decoding.InactivityTimer;
import com.exple.ex_elli.myapp.zxingcode.zxing.decoding.RGBLuminanceSource;
import com.exple.ex_elli.myapp.zxingcode.zxing.view.ViewfinderView;
        ...
        btnFLash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA_FLASH)) {
                    if (isLightOn){
                        CameraManager.get().closeLight();   //close光灯
                        isLightOn = false;
                    }else {
